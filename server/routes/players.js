...
router.get('/', (req, res) => {
  const players = db.prepare(`
    SELECT id, pseudo, total_score, monsters_defeated, undead_defeated, elite_defeated,
...
router.get('/:id', (req, res) => {
  const player = db.prepare(`
    SELECT id, pseudo, save_data, total_score, monsters_defeated, undead_defeated, elite_defeated,
