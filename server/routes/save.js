...
router.put('/', requireAuth, (req, res) => {
  ...
  db.prepare(`
    ...
    SET save_data = ?, total_score = ?, monsters_defeated = ?, undead_defeated = ?,
        elite_defeated = ?, doubles_defeated = ?, invisibles_defeated = ?, necromancer_defeated = ?, influenced_bosses_defeated = ?, shamans_defeated = ?, final_boss_defeated = ?, traps_defeated = ?, bosses_defeated = ?, complete_wings = ?,
  ...
  `).run(
    ...
    score.eliteDefeated, score.doublesDefeated, score.invisiblesDefeated, score.necromancersDefeated, score.influencedBossesDefeated, score.shamansDefeated, score.finalBossDefeated, score.trapsDefeated, score.bossesDefeated, score.completeWings,
