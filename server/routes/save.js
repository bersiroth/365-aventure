...
router.put('/', requireAuth, (req, res) => {
  ...
  db.prepare(`
    ...
    SET save_data = ?, total_score = ?, monsters_defeated = ?, undead_defeated = ?,
        elite_defeated = ?, doubles_defeated = ?, invisibles_defeated = ?, traps_defeated = ?, bosses_defeated = ?, complete_wings = ?,
  ...
  `).run(
    ...
    score.eliteDefeated, score.doublesDefeated, score.invisiblesDefeated, score.trapsDefeated, score.bossesDefeated, score.completeWings,
